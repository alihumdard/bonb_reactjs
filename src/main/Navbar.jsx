        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:flex items-center space-x-3">
              <button className="bg-gray-100 cursor-pointer text-gray-800 font-semibold py-2 px-5 rounded-full hover:bg-gray-200 transition-colors duration-300">
                Donate
              </button>
              <button className="bg-orange-600 cursor-pointer text-white font-semibold py-2 px-5 rounded-full hover:bg-orange-700 transition-colors duration-300">
                Volunteer
              </button>
            </div>
